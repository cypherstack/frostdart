...
const int INVALID_ENCODING_ERROR = 102;

const int INVALID_PARTICIPANT_ERROR = 103;

const int INVALID_SHARE_ERROR = 104;

const int ZERO_PARAMETER_ERROR = 201;

const int INVALID_THRESHOLD_ERROR = 202;

const int INVALID_NAME_ERROR = 203;

const int UNKNOWN_LANGUAGE_ERROR = 204;

const int INVALID_SEED_ERROR = 205;

const int INVALID_AMOUNT_OF_COMMITMENTS_ERROR = 206;

const int INVALID_COMMITMENTS_ERROR = 207;

const int INVALID_AMOUNT_OF_SHARES_ERROR = 208;

const int INVALID_OUTPUT_ERROR = 301;

const int INVALID_ADDRESS_ERROR = 302;

const int INVALID_NETWORK_ERROR = 303;

const int NO_INPUTS_ERROR = 304;

const int NO_OUTPUTS_ERROR = 305;

const int DUST_ERROR = 306;

const int NOT_ENOUGH_FUNDS_ERROR = 307;

const int TOO_LARGE_TRANSACTION_ERROR = 308;

const int WRONG_KEYS_ERROR = 309;

const int INVALID_PREPROCESS_ERROR = 310;
